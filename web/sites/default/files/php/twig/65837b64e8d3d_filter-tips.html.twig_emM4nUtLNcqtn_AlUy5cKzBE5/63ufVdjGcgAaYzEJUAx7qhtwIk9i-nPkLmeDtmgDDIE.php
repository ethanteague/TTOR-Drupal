...
class __TwigTemplate_ea3b3d2056094c1c8ff4fa116ef23e5c extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig", "/home/ttorahos/html_and_drupal/TTOR-Drupal/web/themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig");
    }
